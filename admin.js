...
class StatsCalculator {
  ...
  calculateYearlyStats(year, orders) {
    ...
    const revenue = yearlyOrders.reduce(
...
function updateDashboardStats() {
  ...
  const yearlyStats = statsCalculator.calculateYearlyStats(
    currentYear,
    yearlyOrders
  );
  ...
  requestAnimationFrame(() => {
    ...
    if (totalProfit)
      totalProfit.textContent = formatCurrency(yearlyStats.profit);
  });
}
...
function saveAdminData(e) {
  ...
  const newEmail = document.getElementById("newAdminEmail")
    ...
    : "";
  const currentPassword = document.getElementById("currentAdminPassword")
  ...
  if (document.getElementById("currentAdminPassword"))
    document.getElementById("currentAdminPassword").value = "";
  if (document.getElementById("newAdminPassword"))
    document.getElementById("newAdminPassword").value = "";
  if (document.getElementById("confirmAdminPassword"))
    document.getElementById("confirmAdminPassword").value = "";
